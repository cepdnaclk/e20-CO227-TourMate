...
import {  faMapMarkedAlt,faBookmark , faHotel} from '@fortawesome/free-solid-svg-icons'; 
                ...
                <header className="home-header">
                    ...
                    <div className="home-container-columns">
                        <div className="home-column">
                          <Link to="/create-plan"><button className="main-btn">
                            <FontAwesomeIcon icon={faMapMarkedAlt} size="3x"/>
                            <h3>Create Schedule</h3></button></Link>
                        </div>
                        <div className="home-column">
                        <Link to="/add-bookmarks"><button className="main-btn"><FontAwesomeIcon icon={faBookmark} size="3x" />
                            <h3>Add Bookmarks</h3></button></Link>
                        </div>
                        <div className="home-column">
                        <Link to="/find-places"><button className="main-btn"><FontAwesomeIcon icon={faHotel} size="3x" />
                            <h3>Find Places</h3></button></Link>
                        </div>
                    </div>
                </header>
            </div>
